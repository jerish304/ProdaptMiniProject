...
<th colspan=1>REMOVE FROM LIST</th>
<th colspan=1>MOVE TO CART</th>
...
<tbody>
	...
	%>
			...
			<td>
			<input type="submit" name="viewchoice" value="REMOVE FROM WIST LIST">
			</td>
			<td>
			<input type="submit" name="viewchoice" value="MOVE TO ADDCART">
			</td>
			<td>
